...
pub struct FileState {
    ...
    encryptor: Option<Rc<dyn Encryptor>>,
}
...
impl State for FileState {
    async fn init(&self) -> Result<Vec<StateEntry>, IggyError> {
        ...
        let entries: Vec<StateEntry> = self.load_entries().await?;
