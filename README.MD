...
Poll 2 messages by consumer 0 from the stream `dev` (ID 1) for topic `dummy` (ID 1) and partition 1 starting with offset 0 using string format `s`

`message.poll|0|1|1|1|0|0|2|s`
