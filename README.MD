...
Depending on the hardware and cache settings in `server.json`, you might expect over 3M messages per second throughput (+200 MB/s) for both writes and reads. 
