...
pub async fn init(
    ...
    let noop_storage = SystemStorage {
        info: Rc::new(NoopSystemInfoStorage {}),
        stream: Rc::new(NoopStreamStorage {}),
        topic: Rc::new(NoopTopicStorage {}),
        partition: Rc::new(NoopPartitionStorage {}),
        segment: Rc::new(NoopSegmentStorage {}),
        persister: Rc::new(NoopPersister {}),
    };
