// This file was generated by build.rs. Do not edit by hand.
// If you need to add a new Error variant follow the instructions
// in the README.md in the errors package to add a new Error variant
// to the provided database and then rebuild the project using `cargo build`.
// For further details see the mentioned README.
...
pub enum Error {
    ...
    #[error("Failed to create directory for consumer groups for stream with ID: {0} and topic with ID: {1}")]
