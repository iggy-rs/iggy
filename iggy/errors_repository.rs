...
fn insert_errors(errors_db: &SledDb) -> Result<(), Box<dyn Error>> {
    let error_codes: Vec<ErrorRepositoryEntry> = vec![
        ...
        ErrorRepositoryEntry {
            snake_case_name: "cannot_create_consumer_groups_directory".to_string(),
            code: 5004,
            signature: "u32, u32".to_string(),
            converts_from: "".to_string(),
            template: "Failed to create directory for consumer groups for stream with ID: {0} and topic with ID: {1}".to_string(),
        },
        ErrorRepositoryEntry {
            snake_case_name: "cannot_read_consumer_groups".to_string(),
            code: 5005,
            signature: "u32, u32".to_string(),
            converts_from: "".to_string(),
            template: "Failed to read consumer groups for topic with ID: {0} and stream with ID: {1}".to_string(),
        },
        ErrorRepositoryEntry {
